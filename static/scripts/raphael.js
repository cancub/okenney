...
(function () {
    ...
    paperproto.image = function (src, x, y, w, h) {
        ...
        if (typeof src === "string") {
            out = R._engine.image(this, src || "about:blank", x || 0, y || 0, w || 0, h || 0);
            this.__set__ && this.__set__.push(out);
        }
        else if (typeof src === 'object' && src[0].nodeName == 'svg') {
            this.canvas.replaceWith(src[0]);
            // src.attrs = {x: x, y: y, width: w, height: h, src: src};
            // src.type = "image";
            // return src;
        }
        return out;
